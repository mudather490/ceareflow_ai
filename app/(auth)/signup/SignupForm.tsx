...
export function SignupForm() {
  ...
  const onSubmit = async (values: SignupInput) => {
    ...
    // Otherwise show success message; user will confirm via email.
    setTimeout(() => {
  ...
  if (success) {
    return (
      <div className="rounded-xl bg-surface-container p-4 text-body-sm text-on-surface">
        <p className="font-semibold text-primary">Check your email</p>
        <p className="text-on-surface-variant mt-1">We sent you a confirmation link. You will be redirected shortly.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="text-label-sm text-on-surface-variant uppercase tracking-wider">or sign up with email</span>
        <div className="flex-1 h-px bg-outline-variant" />
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <Input id="email" type="email" placeholder="jane@example.com" className="pl-10" {...register("email")} />
          </div>
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-label-sm text-on-surface-variant">Must be at least 8 characters.</p>
